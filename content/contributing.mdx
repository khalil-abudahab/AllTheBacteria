...
(see the [AllTheBacteria GitHub planning project](https://github.com/orgs/AllTheBacteria/projects/1/views/1)).
...
[checkm2 analysis](https://github.com/AllTheBacteria/AllTheBacteria/tree/main/reproducibility/All-samples/checkm2),
...
First, make a new [AllTheBacteria GitHub issue](https://github.com/AllTheBacteria/AllTheBacteria/issues)
...
[assembly files](https://osf.io/zxfmy/),
...
[AMRfinderPlus results](https://osf.io/7nwrx/) have an extra layer
