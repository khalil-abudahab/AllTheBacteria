...
* [BTyper3](https://github.com/lmc297/BTyper3) v3.4.0 (Standardized taxonomic classification and sequence typing, detection of virulence and Bt toxin-encoding genes)
* Result files are available on OSF in the [Bacillus_cereus_group component](https://osf.io/8ua49/).

*Bordetella pertussis*

* [mlst](https://github.com/tseemann/mlst) schema [2024-06-10](https://www.pubmlst.org)
