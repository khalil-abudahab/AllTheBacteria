...
[Metadata component](https://osf.io/h7wzy/).
...
2. In an [SQLite database](/metadata_sqlite), available for releases
   2024-08 and 2025-05.
...
are described in a separate page: [SQLite metadata](/metadata_sqlite)
...
the [Metadata component](https://osf.io/h7wzy/).
...
[status.202505.tsv.gz](https://osf.io/h7wzy/files/6hw7t).
...
over time. Please see [species calls](/species_id) for more information.
...
[here](/species_id). All other rules remained the same.
