...
[LexicMap](https://github.com/shenwei356/LexicMap) is a nucleotide sequence alignment tool
...
<a id="local-search-with-pre-built-index"></a>
...
<a id="building-an-index-and-searching-locally"></a>
...
7. Searching with LexicMap ([tutorial](https://bioinf.shenwei.me/LexicMap/tutorials/search/)).
