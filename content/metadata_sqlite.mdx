...
please see the [Metadata and QC](/sample_metadata) page.
...
* `scientific_name`: the ENA metadata scientific name. Some samples have
  ...
  the [Species Identification](/species_id) page.
...
* `sylph_species`: this is a species call from running sylph on the reads,
  using the method described in the [Species Identification](/species_id)
  page.
